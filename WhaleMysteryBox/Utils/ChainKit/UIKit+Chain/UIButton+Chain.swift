...
extension Chain where Base: UIButton {
    ...
    @discardableResult
    public func normalImageNamed(_ imageNamed: String) -> Self {
        base.setImage(.init(named: imageNamed), for: .normal)
        return self
    }
    ...
    @discardableResult
    public func selectedImageNamed(_ imageNamed: String) -> Self {
        base.setImage(.init(named: imageNamed), for: .selected)
        return self
    }
    ...
    @discardableResult
    public func disabledImageNamed(_ imageNamed: String) -> Self {
        base.setImage(.init(named: imageNamed), for: .disabled)
        return self
    }
